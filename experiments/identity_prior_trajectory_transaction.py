    ...
    *,
    ...
    cleanup_commands = (
        ...
        (
            ...
            "matched reset phase 1 control: pause overworld clock",
        ),
        (
        ...
        (
            ...
            "matched reset phase 1 cleanup: clear effects",
        ),
        (
            f"clear {username}",
...
def _scientific_player_username(
    ...
    absolute_ordinal = block_index * len(PLANNED_CONDITION_ORDER[0]) + ordinal
